...
- [Mistral / chat.mistral.ai](https://chat.mistral.ai) — Chat web gratuito sin API key; [console.mistral.ai](https://console.mistral.ai) para el nivel gratuito de la API
